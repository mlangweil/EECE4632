; ModuleID = 'F:/EECE4632/HW5/HLS/divide_by_13/divide_by_13/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_divide_by_13_ir(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull dereferenceable(12) %A, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull dereferenceable(12) %B) local_unnamed_addr #0 {
entry:
  ...
  %B_copy.user = alloca i2, align 512
  %B_copy.last = alloca i1, align 512
  %B_copy.id = alloca i5, align 512
  %B_copy.dest = alloca i6, align 512
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* nonnull %A, i32* nonnull align 512 %A_copy.data, i4* nonnull align 512 %A_copy.keep, i4* nonnull align 512 %A_copy.strb, i2* nonnull align 512 %A_copy.user, i1* nonnull align 512 %A_copy.last, i5* nonnull align 512 %A_copy.id, i6* nonnull align 512 %A_copy.dest, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* nonnull %B, i32* nonnull align 512 %B_copy.data, i4* nonnull align 512 %B_copy.keep, i4* nonnull align 512 %B_copy.strb, i2* nonnull align 512 %B_copy.user, i1* nonnull align 512 %B_copy.last, i5* nonnull align 512 %B_copy.id, i6* nonnull align 512 %B_copy.dest)
  call void @apatb_divide_by_13_hw(i32* %A_copy.data, i4* %A_copy.keep, i4* %A_copy.strb, i2* %A_copy.user, i1* %A_copy.last, i5* %A_copy.id, i6* %A_copy.dest, i32* %B_copy.data, i4* %B_copy.keep, i4* %B_copy.strb, i2* %B_copy.user, i1* %B_copy.last, i5* %B_copy.id, i6* %B_copy.dest)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %A, i32* %A_copy.data, i4* %A_copy.keep, i4* %A_copy.strb, i2* %A_copy.user, i1* %A_copy.last, i5* %A_copy.id, i6* %A_copy.dest, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %B, i32* %B_copy.data, i4* %B_copy.keep, i4* %B_copy.strb, i2* %B_copy.user, i1* %B_copy.last, i5* %B_copy.id, i6* %B_copy.dest)
  ret void
}
...
declare void @apatb_divide_by_13_hw(i32*, i4*, i4*, i2*, i1*, i5*, i6*, i32*, i4*, i4*, i2*, i1*, i5*, i6*)
...
define void @divide_by_13_hw_stub_wrapper(i32*, i4*, i4*, i2*, i1*, i5*, i6*, i32*, i4*, i4*, i2*, i1*, i5*, i6*) #5 {
entry:
  %14 = alloca %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"
  %15 = alloca %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"
  call void @copy_out(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %14, i32* %0, i4* %1, i4* %2, i2* %3, i1* %4, i5* %5, i6* %6, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %15, i32* %7, i4* %8, i4* %9, i2* %10, i1* %11, i5* %12, i6* %13)
  call void @divide_by_13_hw_stub(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %14, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %15)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %14, i32* %0, i4* %1, i4* %2, i2* %3, i1* %4, i5* %5, i6* %6, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %15, i32* %7, i4* %8, i4* %9, i2* %10, i1* %11, i5* %12, i6* %13)
  ret void
}

declare void @divide_by_13_hw_stub(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull)
