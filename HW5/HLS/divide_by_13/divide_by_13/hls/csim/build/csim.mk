...
HLS_SOURCES = ../../../../divide_tb.cpp ../../../../divide_by_13.cpp
...
$(ObjDir)/divide_tb.o: ../../../../divide_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../divide_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/divide_tb.d

$(ObjDir)/divide_by_13.o: ../../../../divide_by_13.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../divide_by_13.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/divide_by_13.d
