...
HD_PWD='F:/HW3/Vivado/divisible/divisible.runs/divisible_divisible_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log divisible_divisible_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source divisible_divisible_0_1.tcl
