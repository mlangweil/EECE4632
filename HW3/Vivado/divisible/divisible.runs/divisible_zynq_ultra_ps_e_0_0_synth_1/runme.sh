...
HD_PWD='F:/HW3/Vivado/divisible/divisible.runs/divisible_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log divisible_zynq_ultra_ps_e_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source divisible_zynq_ultra_ps_e_0_0.tcl
