...
HD_PWD='F:/HW3/Vivado/divisible/divisible.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log divisible_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source divisible_wrapper.tcl
