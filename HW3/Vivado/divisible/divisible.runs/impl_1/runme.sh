...
HD_PWD='F:/HW3/Vivado/divisible/divisible.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log divisible_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source divisible_wrapper.tcl -notrace
