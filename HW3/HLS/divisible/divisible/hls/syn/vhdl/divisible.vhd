...
architecture behav of divisible is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "divisible_divisible,hls_ip_2024_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sfvc784-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.265000,HLS_SYN_LAT=35,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=536,HLS_SYN_LUT=584,HLS_VERSION=2024_1}";
    ...
    signal trunc_ln6_fu_59_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal icmp_ln6_fu_63_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component divisible_srem_32ns_5ns_5_36_seq_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component divisible_control_s_axi IS
    generic (
...
begin
    control_s_axi_U : component divisible_control_s_axi
    generic map (
    ...
    srem_32ns_5ns_5_36_seq_1_U1 : component divisible_srem_32ns_5ns_5_36_seq_1
    generic map (
        ID => 1,
        NUM_STAGE => 36,
        din0_WIDTH => 32,
    ...
    c <= std_logic_vector(IEEE.numeric_std.resize(unsigned(icmp_ln6_fu_63_p2),32));
    ...
    icmp_ln6_fu_63_p2 <= "1" when (trunc_ln6_fu_59_p1 = ap_const_lv5_0) else "0";
    trunc_ln6_fu_59_p1 <= grp_fu_53_p2(5 - 1 downto 0);
end behav;
