...
HD_PWD='F:/EECE4632/Lab3/Vivado/stream/stream.runs/dma_axis_ip_example_auto_ds_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_axis_ip_example_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_axis_ip_example_auto_ds_0.tcl
