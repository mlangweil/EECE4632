...
HD_PWD='F:/EECE4632/HW4/Vivado/divide_by_13/stream.runs/dma_axis_ip_example_divide_by_13_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_axis_ip_example_divide_by_13_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_axis_ip_example_divide_by_13_0_0.tcl
